      ...
      >
        <ModalBody py="12" px={{ base: 8, md: 12 }}>
          ...
          <SimpleGrid columns={{ base: 3, md: 3 }} spacing={{ base: 3, md: 4 }}>
            <Flex
              onClick={() =>
                handleClick("Email", "mailto:esther.nmaduabuchi@gmail.com")
              }
              direction="column"
              align="center"
              border="1px solid"
            ...
            <Flex
              onClick={() =>
                handleClick("Github", "https://github.com/Esthermadu")
              }
              direction="column"
              align="center"
              border="1px solid"
            ...
            <Flex
              onClick={() =>
                handleClick("Codepen", "https://codepen.io/Esthermadu")
              }
              direction="column"
              align="center"
              border="1px solid"
            ...
            >
              <RiDriveLine size="36" />
              <Text mt="3">Resume</Text>
            </Flex>
            <Flex
              onClick={() =>
                handleClick(
                  "Linkedin",
                  "https://www.linkedin.com/in/esther-maduabuchi/"
                )
              }
              direction="column"
              align="center"
            ...
            <Flex
              onClick={() =>
                handleClick("Twitter", "https://twitter.com/MNwadiuto")
              }
              direction="column"
              align="center"
              border="1px solid"
